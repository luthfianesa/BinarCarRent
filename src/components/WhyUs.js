...
const WhyUs = () => {
  return (
    <div className="whyUs-container">
      <div className="whyUs-heading-outer-container">
      ...
      <ul className="why-us-ul">
        <div className="card-container">
          <div>
            <img src={Thumb} alt="icon-thumb" className="icon-why-us"></img>
          </div>
          <h4>Mobil Lengkap</h4>
        ...
        <div className="card-container">
          <div>
            <img src={Price} alt="icon-price" className="icon-why-us"></img>
          </div>
          <h4>Harga Murah</h4>
        ...
        <div className="card-container">
          <div>
            <img src={TwentyFourHours} alt="icon-clock" className="icon-why-us"></img>
          </div>
        ...
        <div className="card-container">
          <div>
            <img src={Professional} alt="icon-professional" className="icon-why-us"></img>
          </div>
